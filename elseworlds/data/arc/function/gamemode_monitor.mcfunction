...
execute as @a[gamemode=adventure,tag=mazerunner] at @s unless dimension arc:maze run function arc:maze/remove_adventure
execute as @a[tag=fromHub] at @s unless dimension arc:maze run tag @s remove fromHub
execute as @a[tag=mazerunner] at @s unless dimension arc:maze run tag @s remove mazerunner
