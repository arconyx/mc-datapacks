...
scoreboard objectives add alltreeCoordinateX dummy
scoreboard objectives add alltreeCoordinateY dummy
scoreboard objectives add alltreeCoordinateZ dummy

scoreboard objectives add mazeCoordinateX dummy
