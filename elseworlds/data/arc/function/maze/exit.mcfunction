...
execute as @a[distance=..1] if score @s mazeEntranceDimension matches 3 run function arc:hub/enter/enter
execute as @a[distance=..1] unless score @s mazeEntranceDimension matches 3 run function arc:maze/exit/exit
