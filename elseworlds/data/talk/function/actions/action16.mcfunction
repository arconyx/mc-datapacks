...
execute if score @s talkingTimer matches 240 run return run function talk:say {text: "@s"}
execute if score @s talkingTimer matches 240 run return run function talk:say_raw {text: '[{"text": "@s. "}, {"text": "@s. ", "italic": true}, {"text": "@s. "}]'}
...
execute if score @s talkingTimer matches 520.. unless data entity @s SelectedItem.components.minecraft:custom_name run return run function talk:actions/action16_named
