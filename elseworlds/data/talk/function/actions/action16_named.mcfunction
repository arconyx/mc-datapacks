...
execute if score @s talkingTimer matches 560 run return run function talk:say_raw {text: '[ {"text": "It\'s "}, {"entity": "@s", "nbt": "SelectedItem.components.minecraft:custom_name", "interpret": true}]'}
...
execute if score @s talkingTimer matches 720.. run scoreboard players set @s talkingNameKnown 1
execute if score @s talkingTimer matches 720.. run scoreboard players reset @s talkingActionFlag
