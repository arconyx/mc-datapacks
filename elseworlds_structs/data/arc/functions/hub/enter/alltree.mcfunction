...
execute store result score @s alltreeCoordinateX run data get entity @e[type=minecraft:marker,tag=portal_tree_exit,distance=..4,sort=nearest,limit=1] Pos[0] 1
execute store result score @s alltreeCoordinateY run data get entity @e[type=minecraft:marker,tag=portal_tree_exit,distance=..4,sort=nearest,limit=1] Pos[1] 1
execute store result score @s alltreeCoordinateZ run data get entity @e[type=minecraft:marker,tag=portal_tree_exit,distance=..4,sort=nearest,limit=1] Pos[2] 1
