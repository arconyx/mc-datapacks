...
execute store result score @s purelakeCoordinateX run data get entity @e[type=minecraft:marker,tag=portal_tree_exit,distance=..6,sort=nearest,limit=1] Pos[0] 1
execute store result score @s purelakeCoordinateY run data get entity @e[type=minecraft:marker,tag=portal_tree_exit,distance=..6,sort=nearest,limit=1] Pos[1] 1
execute store result score @s purelakeCoordinateZ run data get entity @e[type=minecraft:marker,tag=portal_tree_exit,distance=..6,sort=nearest,limit=1] Pos[2] 1
